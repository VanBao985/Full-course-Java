...
import static Student_Class_DiemThi.Test.toChucThi;
...
public class LopHoc {
    ...
    public LopHoc(){
        ...
        Student[] temp = new Student[N];
        for (int i = 0; i < N; i++) {
            System.out.println("Input Information Student: " + i);
    ...
    public void printStudentListPoint(){
        ...
        for (int i = 0; i < StudentList.length; i++) {
            System.out.println("Name: "+getStudentListName(i)+", Year: " + getStudentListYear(i)+ ", Point: "+getStudentListPoint(i));
        }
    }
...
class Main{
    ...
    public static void main(String[] args) {
        System.out.println("Cach input sinh vien:");
        int num = scan.nextInt();   // 0 or 1
        LopHoc cls = new LopHoc(0);
        if (num == 0){
            cls = new LopHoc();}
        else {
        ...
        Test test = new Test();
//        test.toChucThi(cls.getStudentList().length,cls.getStudentList());
        System.out.println();
    }
}
